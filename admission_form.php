					...
					<div class="single_content_left">
						...
						<form action="#" method="post" class="apply_from">
							<div class="form-group">
								<div class="row">
									<div class="col-xs-12 col-sm-4">
										<div class="label">Select Class <span class="error">*</span></div>
									</div>
							...
							<div class="form-group">
								<div class="row">
									<div class="col-xs-12 col-sm-4">
										<div class="label">Student Full Name <span class="error">*</span></div>
									</div>
									<div class="col-xs-12 col-sm-8">
										<div class="text-field">
							...
							<div class="form-group">
								<div class="row">
									<div class="col-xs-12 col-sm-4">
										<div class="label">Father Name<span class="error">*</span></div>
									</div>
									<div class="col-xs-12 col-sm-8">
										<div class="text-field">
							...
							<div class="form-group">
								<div class="row">
									<div class="col-xs-12 col-sm-4">
										<div class="label">PASS OUT CLASS <span class="error">*</span></div>
									</div>
									<div class="col-xs-12 col-sm-8">
										<div class="text-field">
											<input type="text" class="form-control" name="fname">
							...
							<div class="form-group">
								<div class="row">
									<div class="col-xs-12 col-sm-4">
										<div class="label">YEAR  <span class="error">*</span></div>
									</div>
									<div class="col-xs-12 col-sm-8">
										<div class="text-field">
							...
							<div class="form-group">
								<div class="row">
									<div class="col-xs-12 col-sm-4">
										<div class="label">AGGREGATE % OF MARKS <span class="error">*</span></div>
									</div>
									<div class="col-xs-12 col-sm-8">
										<div class="text-field">
							...
							<input type="submit" value="Apply For addmition" class="commonBtn">
						</form>
					</div>
				</div>
